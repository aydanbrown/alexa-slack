...
function onIntent(intentRequest, session, callback) {
  ...
  switch(intentRequest.intent.name) {
    case 'MyColorIsIntent': setColorInSession(intent, session, callback); break;
    case 'WhatsMyColorIntent': getColorFromSession(intent, session, callback); break;
    case 'AMAZON.HelpIntent': getWelcomeResponse(callback); break;
